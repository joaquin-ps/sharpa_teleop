...
Usage (from sharpa_teleop repo root)::
    ...
    python retargeting_teleop/viz/view_force_sensing.py
    python retargeting_teleop/viz/view_force_sensing.py --no-tactile
    python retargeting_teleop/viz/view_force_sensing.py --calibrate
    python retargeting_teleop/viz/view_force_sensing.py --finger index
