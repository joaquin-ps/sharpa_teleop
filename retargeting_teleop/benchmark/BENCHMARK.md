...
```bash
python retargeting_teleop/benchmark/diagnose_ditto_reads.py <mode> [options]
```
...
python retargeting_teleop/benchmark/diagnose_ditto_reads.py ping --3f --sync-read
```
...
- Plot saved to `retargeting_teleop/benchmark/diagnose_ditto_reads_sweep.png` —
...
python retargeting_teleop/benchmark/diagnose_ditto_reads.py trials --read-mode all
```
...
Plot: `retargeting_teleop/diagnose_ditto_reads_methods.png` (cwd-relative default).
