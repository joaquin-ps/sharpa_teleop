...
Usage (from sharpa_teleop repo root):
    ...
    python sharpa_teleop/viz/view_assets.py --sharpa-only
    python sharpa_teleop/viz/view_assets.py --leader-only
    python sharpa_teleop/viz/view_assets.py --3f   # 3-finger Ditto leader URDF
...
from teleop.engine import DittoSharpaEngine
...
if TYPE_CHECKING:
    ...
    from teleop.ditto_sharpa_teleop import DittoSharpaTeleop
...
def run_viewer(
    *,
    ...
    engine: DittoSharpaEngine | None = None
