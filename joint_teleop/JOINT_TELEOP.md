...
# 3-DoF middle (motors 131, 132, 133) — same gains/ROM as index
python joint_teleop/sharpa_teleop_controller.py hand_config=sharpa_3dof_middle
...
| `sharpa_3dof_middle` | 131, 132, 133 | Middle MCP AA + MCP flex + PIP |
